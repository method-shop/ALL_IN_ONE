...
user_new_names = {}
@bot.message_handler(commands=['file_rename'])
def send_welcome(message):
    bot.reply_to(message, f"""<b>Welcome to the file renamer . Send me a file to rename it. By @Privates_Bots</b>""",parse_mode="HTML") 
